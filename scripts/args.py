...
def get_args():
    ...
    parser.add_argument('--algorithm', type=str, default='FiSSC', help='Algorithm/s to use. Options: paper, greedy, mis_ilp', choices=['FiSSC', 'Greedy', 'MIS_ILP', 'debug_ILP', 'preprocess_test','MIS_ILP_p1','MIS_ILP_p2', 'verify_solution', 'p1', 'p2'])

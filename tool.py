...
def paper_algorithm_part_1(args, experiment_name, file_path):
    starting_time = time.time()
    print(f'Working on {experiment_name}, {file_path}')
...
def paper_algorithm_part_2(args, experiment_name, file_path):
    print(f'Working on {experiment_name}, {file_path}')
    preprocessed_file = f'data/{experiment_name}.csv'
    working_sequences_file_path = f'data/{experiment_name}_filtered_working.csv'
    picked_sequences_file_path = f'data/{experiment_name}_filtered_picked.csv'
...
def main():
    ...
    elif args.algorithm == 'p1':
        paper_algorithm_part_1(args, experiment_name, file_path)
    elif args.algorithm == 'p2':
        paper_algorithm_part_2(args, experiment_name, file_path)
